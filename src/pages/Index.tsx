          ...
          <div className="p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500 mt-1">Items above threshold</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold">Medium Stock</h3>
                <p className="text-3xl font-bold text-yellow-600 mt-2">89</p>
                <p className="text-sm text-gray-500 mt-1">Items need monitoring</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <div className="p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-3xl font-bold text-blue-600 mt-2">₹2,15,840</p>
                <p className="text-sm text-gray-500 mt-1">+8% from last week</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold">This Month</h3>
                <p className="text-3xl font-bold text-purple-600 mt-2">₹8,45,670</p>
                <p className="text-sm text-gray-500 mt-1">+15% from last month</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold">Orders</h3>
                <p className="text-3xl font-bold text-orange-600 mt-2">342</p>
          ...
          <div className="p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500 mt-1">Compared to last quarter</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 className="text-lg font-semibold">Customer Retention</h3>
                <p className="text-3xl font-bold text-blue-600 mt-2">87%</p>
                <p className="text-sm text-gray-500 mt-1">Monthly retention rate</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <div className="p-4 md:p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-3xl font-bold text-blue-600">981</p>
                <p className="text-sm text-gray-500 mt-1">+15 this week</p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-3xl font-bold text-green-600">₹67,890</p>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                <p className="text-sm text-gray-500 mt-1">+28 today</p>
              </div>
            </div>
